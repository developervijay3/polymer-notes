...
This is a simple note app using a drawer-based
...
This is a simple notes application that allow you to create, edit and delete notes using simple polymer route
